          ...
          <Collapse in={!!paciente}>
            {paciente && (
              <Box sx={{ p: 2, border: '1px solid #e0e0e0', borderRadius: 2, mt: 2, bgcolor: '#f9f9f9' }}>
                ...
                <Typography><strong>Fecha Nac.:</strong> {new Date(paciente.fecha_nacimiento).toLocaleDateString()}</Typography>
                <Typography><strong>Teléfono:</strong> {paciente.telefono || 'No registrado'}</Typography>
                <Typography><strong>Dirección:</strong> {paciente.direccion || 'No registrada'}</Typography>
              </Box>
            )}
          </Collapse>
